		...
		<main style={{backgroundColor: theme.background, color: theme.color}}>
			...
			<div className='container py-5'>
				...
				<section>
					...
					<p>
						Our mission is to make networking easier and more efficient with
						an intuitive, eco-friendly, and digital approach to exchanging
					...
					<p>
						At bCards, we envision a world where networking is effortless,
						paper waste is reduced, and every professional can share their
						contact details instantly, no matter where they are. Join us in
